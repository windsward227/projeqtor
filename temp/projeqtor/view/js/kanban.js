    ...
    load : function(data) {
      if(data.indexOf('messageError/split/')!=-1){
        ...
        if((data.indexOf('needResult')!=-1 && typeof dojo.byId("kanbanResultEditorType") != 'undefined')
    		|| (data.indexOf('description')!=-1 && typeof dojo.byId("descriptionEditorType") != 'undefined'))functionCallback=function(){
          ...
          } else if (dijit.byId("liveMeetingResult") && dijit.byId("kanbanResult")) { // Dojo type editor
          ...
          if (editorTypeDescription=="CK") { // CKeditor type
	        ckEditorReplaceEditor("description",999);
	      } else if (dijit.byId("liveMeetingResult") && dijit.byId("description")) { // Dojo type editor
...
function saveKanbanResult(id,type,newStatut){
  ...
  tmpCkEditorDescription='';
  if(typeof CKEDITOR.instances.description != 'undefined'){
    CKEDITOR.instances.description.updateElement();
    tmpCkEditorDescription=CKEDITOR.instances.description.document.getBody().getText();
  }
  ...
  if(!form.validate()){
    ...
    if(extraRequiredVal && ((typeof dijit.byId('kanbanResourceList') != 'undefined' && dijit.byId('kanbanResourceList').get('value').trim()!='') || typeof dijit.byId('kanbanResourceList') == 'undefined')
			  ...
			  &&( (typeof CKEDITOR.instances.description == 'undefined' || (typeof CKEDITOR.instances.description != 'undefined' && tmpCkEditorDescription.trim()!='')) && ((typeof dijit.byId('description') != 'undefined' && dijit.byId('description').get('value').trim()!='') || typeof dijit.byId('description') == 'undefined'))
...
//	    if(typeof CKEDITOR.instances.description !='undefined')valCk=CKEDITOR.instances.description.getData();
//	    if(!( (typeof CKEDITOR.instances.description == 'undefined' || (typeof CKEDITOR.instances.description != 'undefined' && tmpCkEditorDescription.trim()!='')) && ((typeof dijit.byId('description') != 'undefined' && dijit.byId('description').get('value').trim()!='') || typeof dijit.byId('description') == 'undefined')))
//	    {
//	      if(finalMessage!='')finalMessage+='<br/>';

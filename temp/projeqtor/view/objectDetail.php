...
//       }
    ...
    pq_substr($col, 0, 6)!='_void_' and pq_substr($col, 0, 7)!='_label_' and pq_substr($col, 0, 8)!='_button_' and pq_substr($col, 0, 7)!='_byMet_') { // field not to be displayed
      ...
      if (is_object($val)) {
        ...
        echo ' <div class="dijit dijitReset dijitInline dijitLeft input required readonly generalColClassNotReadonly userImapClass dijitTextBox dijitValidationTextBox" style="'.(($readOnly)?'background-color:#f0f0f0 !important;':'').'width:'.$largeWidth.'px">';
...
//   }
  ...
  foreach ($list as $assignment) {
    ...
    $name=SqlList::getNameFromId('Resource', $assignment->idResource);
...
function drawAttributionVote($obj,$list) {
  ...
  foreach ($list as $val) {
    ...
    echo '    <td class="assignData" align="center" style="white-space: nowrap;vertical-align: middle;">'.htmlFormatDate($nextDate).'</td>';

...
$idRole=RequestHandler::getId('idRole',false,0);
      ...
      <td>
         ...
         <table>
           <tr>
             ...
             <?php }else if(Module::isModuleActive('moduleSkillManagement') and property_exists($refType, '_ActivitySkill') and !empty($obj->_ActivitySkill) and !$isTeam and !$isOrganization and !$isResourceTeam){ ?>
             <td style="vertical-align: top">

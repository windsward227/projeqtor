...
class SSO
{
    public static function isEnabled() {
      $SSOenabled = pq_strtolower(Parameter::getGlobalParameter('SAML_allow_login')); // If SAML is enabled
    ...
    public static function getAttributeName($attribute) {
      $attr=Parameter::getGlobalParameter('SAML_attribute'.pq_ucfirst($attribute));
      if ($attr) return $attr; 
      else return $attribute;
    }
    public static function getCommonName($removeQuotes=false) {
    	$ssoCommonName=Parameter::getGlobalParameter('SAML_ssoCommonName');
    	if ($ssoCommonName and $removeQuotes) return pq_str_replace("'"," ",$ssoCommonName);

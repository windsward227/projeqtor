...
//             continue; // specific field
          } else if ($last and ! $obj->isAttributeSetToField($fld,'hidden') and $fld!='_sortCriteriaForList' and $fld!='_calculateForColumn') { // not a specific field, after $last (notes, attachment, link)
            $errorClass[]=$class;
            break;
          }
        }

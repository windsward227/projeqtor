          ...
          <tr>
           ...
           <table style="width:98%">
              ...
              <tr>
                ...
                <input dojoType="dijit.form.NumberTextBox" <?php echo $isReadOnly; ?> id="charge<?php echo $comp->id;?>" name="charge<?php echo $comp->id;?>" type="text" style="padding:0 !important;margin:0 !important; height:100% !important;width:100% !important;" class="input"  value="<?php if($mode=='edit'){echo Work::displayWork($tabCompValues[$comp->id]['charge']);} ?>" />
                </td>
                <?php } ?>
              </tr>
              <tr>
